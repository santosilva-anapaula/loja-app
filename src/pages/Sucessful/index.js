...
const Sucessful = () => {
    ...
    return (
        <main className='h-screen banner bg-zinc-800 bg-blend-soft-light'>
            <div className='max-w-screen-xl py-20 mx-auto px-6'>
                <div className='flex flex-col items-center justify-center h-3/4 pt-24 pb-20 bg-zinc-900 rounded-xl'>
                    <h1 className='text-3xl text-center text-zinc-100 font-semibold flex space-y-3'>Pedido Realizado!</h1>
                    <img src={image} alt='Imagem de sucesso do pedido' className='w-96 object-contain' />
